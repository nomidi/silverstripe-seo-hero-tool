...
class SeoHeroToolGoogleAnalyticsTest extends FunctionalTest
{
    ...
    public function testModusDev()
    {
        ...
        $this->assertTrue(is_numeric($body), _t('SeoHeroToolGoogleAnalytics.CantFindInTemplate').vsprintf(_t('SeoHeroToolGoogleAnalyticsTest.ModeTestedMode'), array('dev', 'dev')));
