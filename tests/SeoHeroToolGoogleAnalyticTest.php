...
class SeoHeroToolGoogleAnalyticTest extends FunctionalTest
{
    ...
    public function testModusDev()
    {
        ...
        $this->assertTrue(is_numeric($body), _t('SeoHeroToolGoogleAnalytic.CantFindInTemplate').vsprintf(_t('SeoHeroToolGoogleAnalyticTest.ModeTestedMode'), array('dev', 'dev')));
